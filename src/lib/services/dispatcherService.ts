...
export const INITIAL_DEMO_COURTS: CourtInfo[] = [
  {
    ...
    status: 'in_progress',
    currentMatch: INITIAL_DEMO_MATCHES[0],
    matchStartedAt: new Date(Date.now() - 14 * 60 * 1000).toISOString(),
    umpireName: 'Trần Văn Quyết',
    serviceJudgeName: 'Lê Thu Trang',
    nextMatch: INITIAL_DEMO_MATCHES[3],
  },
  {
    courtNumber: 2,
    courtName: 'Sân 2 (Thảm Victor)',
    status: 'warmup',
    currentMatch: INITIAL_DEMO_MATCHES[1],
    warmupSecondsLeft: 75,
    matchStartedAt: null,
    umpireName: 'Hoàng Đình Khoa',
    nextMatch: INITIAL_DEMO_MATCHES[4],
  },
  {
    courtNumber: 3,
